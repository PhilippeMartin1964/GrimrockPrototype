...
**Référence courante : 27 août 2026, TD07.3.3.5 characterization gate à valider.**  
...
| [SAVE_PERSISTENCE_FOUNDATION.md](SAVE_PERSISTENCE_FOUNDATION.md) | Save prototype v13 exact-match ; aucune migration arrière. |
