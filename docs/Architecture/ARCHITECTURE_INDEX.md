...
**Référence courante : 27 août 2026, TD07.3.3.3 validé — TD07.3.3.4 prochain.**  
...
| [SAVE_PERSISTENCE_FOUNDATION.md](SAVE_PERSISTENCE_FOUNDATION.md) | Save prototype v12 exact-match ; aucune migration arrière. |
