...
**Référence courante : 27 août 2026, TD07.3.3 clos ; TD07.3.4.2 Canonical Authoring Asset Identity implémenté — à valider.**  
...
| [SAVE_PERSISTENCE_FOUNDATION.md](SAVE_PERSISTENCE_FOUNDATION.md) | Save prototype v20 exact-match ; aucune migration arrière. |
