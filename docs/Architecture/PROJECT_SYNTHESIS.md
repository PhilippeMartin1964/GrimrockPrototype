...
> État : **28 août 2026, TD07.3.5.4 Monster Range normalisation implémentée — à valider.**
...
| Dernière tranche validée | `TD07.3.5.3 — Monster Presentation Authority` |
| Tranche active | `TD07.3.5.4 — Monster Range Schema` — implémentée, à valider |
