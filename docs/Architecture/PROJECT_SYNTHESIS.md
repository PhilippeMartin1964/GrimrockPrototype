...
> État : **27 août 2026, TD07.3.3.4 validé — TD07.3.3.5 prochain.**
...
| Tranche active | `TD07.3.3.5 — Normalize XP / Level / Class Progression` — prochain |
