...
> État : **27 août 2026, TD07.3.3.8 Status Effects validé et clos ; TD07.3.3.9 Level-Up Notification State à ouvrir.**
...
| Tranche active | `TD07.3.3.9 — Normalize Level-Up Notification State` — à ouvrir |
