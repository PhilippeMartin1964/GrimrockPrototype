...
> État : **28 août 2026, TD07.3.3 clos ; TD07.3.4.4 Authoring Cleanup v22 implémenté — à valider.**
...
| Tranche active | `TD07.3.4.4 — Companion / Creation Authoring Cleanup` — v22 implémenté, à valider |
