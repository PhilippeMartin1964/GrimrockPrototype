...
> État : **27 août 2026, TD07.3.3.6 implémenté — validation requise.**
...
| Tranche active | `TD07.3.3.6 — Normalize Skills` — implémentée, à valider |
