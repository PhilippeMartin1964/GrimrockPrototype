...
> État : **28 août 2026, TD07.4 validé/clos sans extraction ; TD07.5 à ouvrir ; MON21.4 suspendu.**
...
| Tranche active | `TD07.5 — Suspended test infrastructure / branch recovery` |
