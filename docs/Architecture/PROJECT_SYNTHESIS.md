...
> État : **27 août 2026, TD07.3.3.6 characterization validée — normalization active.**
...
| Tranche active | `TD07.3.3.6 — Normalize Skills` — normalization active |
