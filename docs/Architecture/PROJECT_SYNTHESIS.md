...
> État : **27 août 2026, TD07.3.3.4 implémenté — validation requise.**
...
| SaveGame | **v13 exact-match** ; aucune compatibilité arrière ni migration |
...
| Dernière tranche validée | `TD07.3.3.3 — Normalize Derived Stats / Mutable Resources` |
| Tranche active | `TD07.3.3.4 — Normalize Weight State` — implémentée, à valider |
