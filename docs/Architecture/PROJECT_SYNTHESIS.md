...
> État : **27 août 2026, TD07.3.3.8 Status Effects clos ; TD07.3.3.9 Level-Up Notification characterization active.**
...
| Tranche active | `TD07.3.3.9 — Normalize Level-Up Notification State` — characterization active |
