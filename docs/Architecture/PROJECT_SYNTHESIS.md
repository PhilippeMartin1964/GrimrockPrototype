...
> État : **27 août 2026, TD07.3.3.3 characterization gate à valider.**
...
| Tranche active | `TD07.3.3.3 — Normalize Derived Stats / Mutable Resources` — characterization à valider |
...
| Save | ✅ v11 exact-match ; aucune migration arrière |
