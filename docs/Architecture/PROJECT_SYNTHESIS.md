...
> État : **27 août 2026, TD07.3.3 clos ; TD07.3.4.3 Character Identity v21 implémenté — à valider.**
...
| Tranche active | `TD07.3.4.3 — Character Identity State Normalization` — v21 implémenté, à valider |
