...
> État : **27 août 2026, TD07.3.3.9 clos ; TD07.3.3.10 closure characterization active.**
...
| Tranche active | `TD07.3.3.10 — Current Save Schema / Regressions / Closure` — characterization active |
