...
> État : **27 août 2026, TD07.3.3.4 characterization validée — normalization active.**
...
| Tranche active | `TD07.3.3.4 — Normalize Weight State` — normalization active |
