...
> État : **28 août 2026, TD07.3.6 Remaining Legacy API/Data Purge characterization prepared — à valider.**
...
| Tranche active | `TD07.3.6 — Remaining Legacy API/Data Purge` — characterization prepared, à valider |
