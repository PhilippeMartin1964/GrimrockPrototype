...
> État : **27 août 2026, TD07.3.3.2 implémenté — validation requise.**
...
| Tranche active | `TD07.3.3.2 — Remove Legacy Attribute Bridge` — implémentée, à valider |
