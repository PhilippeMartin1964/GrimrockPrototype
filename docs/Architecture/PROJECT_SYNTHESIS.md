...
> État : **27 août 2026, TD07.3.3.3 validé — TD07.3.3.4 prochain.**
...
| Tranche active | `TD07.3.3.4 — Normalize Weight State` — prochain |
...
TD07.3.3.4   Normalize Weight State                            PROCHAIN
