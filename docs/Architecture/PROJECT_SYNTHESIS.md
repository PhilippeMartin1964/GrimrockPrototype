...
> État : **27 août 2026, TD07.3.3.7 Spellbook clos ; TD07.3.3.8 Status Effects régressions 111/111 validées — Shipping requis.**
...
| Tranche active | `TD07.3.3.8 — Normalize Status Effects` — régressions validées, Shipping requis |
...
TD07.3.3.8   Normalize Status Effects                                  RÉGRESSIONS VALIDÉES — SHIPPING
