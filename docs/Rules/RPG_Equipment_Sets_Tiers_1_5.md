...
- être représentables par des `DataAssets` et des maillages modulaires dans Unreal Engine.

Un tier d’équipement représente une **qualité et une étape de campagne**, et non une obligation absolue de niveau. Pour le prototype limité aux niveaux 1 à 5, un tier peut être testé par niveau. Dans la campagne complète, les tiers couvriront des plages de niveaux plus larges.
...
Les armes, boucliers, focaliseurs, outils et bijoux sont associés au tier, mais ne comptent pas dans les bonus de set à 3, 6 et 9 pièces.
...
| 9 | Pouvoir signature avec condition ou temps de recharge |

Les bonus ne se cumulent qu’au sein d’un même set et d’un même tier. Un personnage peut mélanger les pièces, mais perd alors les paliers supérieurs.
...
La rareté doit rester immédiatement lisible dans l’inventaire, les infobulles, les bordures d’icônes, les fiches d’objet et les effets visuels. La couleur de rareté est globale ; la couleur secondaire de classe peut être utilisée à l’intérieur de l’icône, sur les gemmes, les runes ou les particules.

| Tier | Rareté | Couleur principale | Hex principal | Bordure UI recommandée | Hex bordure | Effet lumineux recommandé |
|---:|---|---|---|---|---|---|
...
| Alchimiste | Bleu-vert / ambre | Fioles, bombes, catalyseurs, vapeurs alchimiques |
...
### 2.5 Progression visuelle commune

| Tier | Lecture visuelle attendue |
|---:|---|
| 1 | Matériaux usés, tissus simples, cuir ou fer courant, aucune gemme, aucun effet magique majeur |
| 2 | Meilleure coupe, renforts plus propres, premières bordures métalliques, toujours sans pierres précieuses visibles |
| 3 | Première apparition de gemmes, premières lueurs localisées, gravures ou runes discrètes |
| 4 | Dorures nettes, gemmes multiples, effets lumineux visibles, silhouette plus héroïque |
| 5 | Or dominant mais non exclusif, gemmes majeures, parties brillantes ou flamboyantes, aura légendaire |
...
| Halfelin | Pièces compactes, baudriers accessibles, aucune traîne, poids réduit | **Chance halfeline** : `+1 Esquive` ; une fois par repos, relancer un jet de Discrétion ou d’Acrobatie raté |
...
| 3 | **Bastion Runique** : plaques gravées, saphirs sobres, lueurs défensives | 35 / 11 | Marteau runique `1d10+2`, pavois `+2 Défense` | `+2 Bouclier` | `+10 %` résistance Foudre et Arcane | **Onde de bouclier** : Coup de bouclier inflige `+1d6` contondant ; temps de recharge de 3 actions |
...
| 5 | **Citadelle Vivante** : alliage ancien, or royal, gemmes majeures, runes flamboyantes | 54 / 18 | Épée du rempart `2d8+4`, égide `+3 Défense` | `+3 Armures` | Tant que le guerrier est au rang avant, les alliés adjacents gagnent `+2 Armure physique` | **Dernier rempart** : sous 30 % de PV, gagne 12 Armure physique et Provocation ; une fois par repos |
...
| Tier | Set et apparence | Armure P/M | Armement associé | Bonus 3 pièces | Bonus 6 pièces | Bonus 9 pièces |
|---:|---|---:|---|---|---|---|
| 1 | **Maraudeur des Égouts** : cuir usé, toile sombre, boucles de cuivre | 10 / 8 | Dague `1d6`, 3 couteaux `1d4` | `+1 Discrétion` | `+1 Esquive` | **Main sûre** : `+2` au premier jet de Crochetage ou de Désamorçage après un repos |
...
| 3 | **Lame du Crépuscule** : cuir noir huilé, renforts d’argent terni, premières améthystes | 19 / 16 | Stylet `1d6+2`, shurikens `1d4+2` | `+2 Désamorçage` | `+2 Précision` avec armes légères ou de jet | **Fumée évasive** : à 50 % de PV, devient Invisible pendant une action ; une fois par combat |
...
| 4 | **Maître des Lisières** : cuir de monstre, dorures sylvestres, énergie verte | 30 / 18 | Arc composite `1d12+3`, épieu `1d12+3` | `+2 Monstres` | `+2 Précision` contre la cible marquée | **Perce-écaille** : Tir perforant ignore 25 % de l’armure physique ; temps de recharge de 3 actions |
...
| 4 | **Archimage de la Veille** : robe structurée, orbe lumineux, dorures arcaniques | 11 / 39 | Sceptre `1d8+3 Arcane`, grimoire majeur | `+2 Identification` | `+2` aux jets d’application des états magiques si l’armure magique de la cible est à 0 | **Contresort** : annule le premier effet magique hostile de chaque combat |
| 5 | **Souverain des Arcanes** : tissu impossible, or royal, grands cristaux et flammes violettes | 14 / 48 | Bâton du Nexus `2d6+4 Arcane` | `+3 Arcane` | `+8 Mana maximal` et `+10 % Armure magique` | **Convergence** : prochain sort de zone gagne `+50 %` de dégâts ou de durée ; une fois par repos |

Au tier 2 et au-delà, chaque set de Mage reçoit une rune d’affinité interchangeable : Feu, Glace/Eau, Foudre/Air, Terre/Poison, Arcane ou Illusion. La rune modifie les bonus élémentaires, la couleur des détails et certains effets visuels, sans nécessiter six maillages complets.
...
| 4 | **Hiérophante du Sanctuaire** : plaques claires, étole runique, lumière dorée | 35 / 30 | Marteau solaire `1d10+3`, égide bénie | `+2 Volonté` | Les soins dissipent Brûlé ou Empoisonné une fois par cible et par combat | **Sanctuaire** : l’allié le plus blessé gagne 8 Armure magique ; temps de recharge de 4 actions |
...
**Protection dominante** : armure magique et résistances aux éléments et toxines.  
...
| 2 | **Artificier des Galeries** : tablier épais, fioles protégées, harnais organisé | 11 / 18 | Bombes feu/huile `1d6+1` | `+1 Lancer` | `+1 Précision` avec bombes et flasques | **Mèche rapide** : la première bombe du combat ne déclenche pas son temps de recharge normal |
| 3 | **Distillateur Toxique** : masque-filtre, verre vert sombre, premières gemmes bleu-vert | 15 / 25 | Bombes poison/acide `2d6+2` | `+2 Poison` | `+15 %` résistance Poison et Acide | **Nuage persistant** : les surfaces de poison durent une action de plus |
| 4 | **Maître des Réactions** : plaques de cuivre, conduits, valves, dorures nettes | 19 / 31 | Bombes élémentaires `2d6+3` | `+2 Mécanique` | Réactions Feu+Huile, Feu+Poison ou Eau+Foudre infligent `+1d6` | **Catalyse instantanée** : transforme immédiatement une surface cible ; temps de recharge de 4 actions |
...
2. L’armure physique et l’armure magique accordées par les sets doivent suivre le rôle sans rendre une protection inexistante.
...
> Note : les liens ci-dessus sont des chemins cibles recommandés. Tant que les fichiers image ne sont pas ajoutés au dépôt, ils doivent rester traités comme références de production et non comme liens actifs garantis. L’archive locale contient les références disponibles au moment de la rédaction ; les images du Guerrier doivent être vérifiées ou réimportées dans le lot d’assets définitif si elles ne figurent pas dans l’archive.

### 14.1 Convention de nommage des images

Pour faciliter l’intégration ultérieure, les fichiers d’images devraient suivre cette convention :

```text
Tier_01_<Nom_du_set>.png
Tier_02_<Nom_du_set>.png
Tier_03_<Nom_du_set>.png
Tier_04_<Nom_du_set>.png
Tier_05_<Nom_du_set>.png
```

Exemples de correspondance :

| Classe | Tier | Nom de fichier recommandé |
|---|---:|---|
| Mage | 1 | `Tier_01_Apprenti_des_Cendres.png` |
| Rôdeur | 5 | `Tier_05_Seigneur_des_Etoiles_Sylvestres.png` |
| Prêtre | 5 | `Tier_05_Hierophante_Divin.png` |
| Alchimiste | 3 | `Tier_03_Alchimiste_Mystique.png` |
| Voleur | 5 | `Tier_05_Voile_de_la_Main_Invisible.png` |
...
3. Produire les tiers 2 à 5 en réutilisant le squelette, les points d’attache et une partie des maillages modulaires.
...
- Décider si les variantes raciales conservent une résonance mécanique ou deviennent purement visuelles en mode compétitif ou en équilibrage strict.
