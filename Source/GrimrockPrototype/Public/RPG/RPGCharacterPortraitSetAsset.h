...
public:
	...
	void GetPortraitsForGender(ERPGCharacterPortraitGender Gender, TArray<FRPGCharacterPortraitVariant>& OutPortraits) const;

	UFUNCTION(BlueprintPure, Category = "RPG|Portrait Set")
	bool FindPortraitVariant(ERPGCharacterPortraitGender Gender, FName VariantId, FRPGCharacterPortraitVariant& OutVariant) const;

	UFUNCTION(BlueprintPure, Category = "RPG|Portrait Set")
	bool GetFirstValidPortrait(ERPGCharacterPortraitGender Gender, FRPGCharacterPortraitVariant& OutVariant) const;

	const TArray<FRPGCharacterPortraitVariant>& GetPortraitsForGenderRef(ERPGCharacterPortraitGender Gender) const;
};
