 ...
 */
DECLARE_MULTICAST_DELEGATE_FourParams(FGridCharacterExperienceAwardedNativeSignature, int32 /* CharacterIndex */, int32 /* AwardedExperience */,
	int32 /* PreviousExperience */, int32 /* NewExperience */);
...
{
	static int32 AwardToActiveParty(UGridPartyInventoryComponent* PartyInventoryComponent, int32 TotalExperienceReward);

	static FGridCharacterExperienceAwardedNativeSignature& OnCharacterExperienceAwarded();
};
