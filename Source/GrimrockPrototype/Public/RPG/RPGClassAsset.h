...
struct FRPGClassProgressionLevelGrant
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "RPG|Class|Progression", meta = (ClampMin = "0"))
...
struct FRPGClassProgressionChoiceDefinition
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "RPG|Class|Progression", meta = (MultiLine = "true"))
	FText Description;
...
public:
	...
	const FRPGClassProgressionChoiceDefinition* FindProgressionChoice(FName ChoiceId) const;
};
