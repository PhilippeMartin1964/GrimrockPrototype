...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "RPG|Companion", meta = (MultiLine = "true"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "RPG|Companion", meta = (ClampMin = "1", ClampMax = "20"))
	int32 Level = 1;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "RPG|Companion|Recruitment", meta = (MultiLine = "true"))
