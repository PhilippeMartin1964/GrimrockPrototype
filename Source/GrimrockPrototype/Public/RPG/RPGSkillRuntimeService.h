...
{
    static bool TryGetCharacterSkillRank (
        const UGridPartyInventoryComponent* PartyInventory,
        int32 CharacterIndex,
        FName SkillId,
        int32& OutRank);

    static bool TryGetSelectedCharacterSkillRank (
        const UGridPartyInventoryComponent* PartyInventory,
        FName SkillId,
        int32& OutRank);

    static bool TrySetCharacterSkillRank (
    ...
    static bool TryIncreaseCharacterSkillRank (
        UGridPartyInventoryComponent* PartyInventory,
        int32 CharacterIndex,
        const URPGSkillAsset* SkillDefinition,
        int32 Delta,
    ...
    static bool TryResolveCharacterSkillCheck (
        const UGridPartyInventoryComponent* PartyInventory,
        int32 CharacterIndex,
        const URPGSkillAsset* SkillDefinition,
        int32 Difficulty,
    ...
    static bool TryResolveSelectedCharacterSkillCheck (
        const UGridPartyInventoryComponent* PartyInventory,
        const URPGSkillAsset* SkillDefinition,
        int32 Difficulty,
        FRandomStream& RandomStream,
