...
{
public:
	static bool BuildOne(const FGridStatusEffectRuntimeState& State, FGridStatusEffectPresentationView& OutView);

	static void Build(const FGridStatusEffectCollection& StatusEffects, TArray<FGridStatusEffectPresentationView>& OutViews);

	static FText FormatCompactDuration(EGridStatusEffectDurationUnit DurationUnit, int32 RemainingDuration);

	static FText FormatDuration(EGridStatusEffectDurationUnit DurationUnit, int32 RemainingDuration);

	static FText BuildSummary(const TArray<FGridStatusEffectPresentationView>& Views);
};
