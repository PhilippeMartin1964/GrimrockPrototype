...
struct GRIMROCKPROTOTYPE_API FGridStatusEffectApplyResult
{
	...
	{
		return Outcome == EGridStatusEffectApplyOutcome::Added || Outcome == EGridStatusEffectApplyOutcome::RefreshedDuration ||
			Outcome == EGridStatusEffectApplyOutcome::AddedStacks || Outcome == EGridStatusEffectApplyOutcome::ReplacedStronger;
	}

	void Reset()
	{
		*this = FGridStatusEffectApplyResult();
	}
};
...
struct GRIMROCKPROTOTYPE_API FGridStatusEffectAdvanceResult
{
	...
	{
		return !AdvancedEffectIds.IsEmpty();
	}
...
struct GRIMROCKPROTOTYPE_API FGridStatusEffectCollection
{
	...
	bool TryAdd(const UGridStatusEffectDefinitionAsset& Definition, const FGuid& SourceId, int32 InitialStackCount, int32 DurationOverride, FString& OutError);

	bool TryAdd(const UGridStatusEffectDefinitionAsset& Definition, const FGuid& SourceId, FString& OutError)
	{
		return TryAdd(Definition, SourceId, 1, INDEX_NONE, OutError);
	}

	bool TryApply(const UGridStatusEffectDefinitionAsset& Definition, const FGuid& SourceId, int32 InitialStackCount, int32 DurationOverride,
		int32 PotencyOverride, FGridStatusEffectApplyResult& OutResult, FString& OutError);

	bool TryApply(const UGridStatusEffectDefinitionAsset& Definition, const FGuid& SourceId, FGridStatusEffectApplyResult& OutResult, FString& OutError)
	{
