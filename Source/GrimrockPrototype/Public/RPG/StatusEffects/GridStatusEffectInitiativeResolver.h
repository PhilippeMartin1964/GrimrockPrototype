...
public:
     ...
     */
	static int32 ComputeModifier(const FGridStatusEffectCollection& StatusEffects);

	/** Returns one active effect's saturated initiative contribution. */
	static int32 ComputeContribution(const FGridStatusEffectRuntimeState& StatusEffect);
};
