...
{
    GRIMROCKPROTOTYPE_API bool ValidateDefinitions (
     ...
     */
    GRIMROCKPROTOTYPE_API bool EnsureInitialized (
        const UGridLevelAsset& LevelAsset,
        FGridLevelRuntimeState& RuntimeState,
        FString& OutError);

    GRIMROCKPROTOTYPE_API bool ResetToDefaults (
        const UGridLevelAsset& LevelAsset,
        FGridLevelRuntimeState& RuntimeState,
        FString& OutError);
    ...
    GRIMROCKPROTOTYPE_API bool ValidateDungeonSnapshots (
        const FGridDungeonRuntimeState& DungeonState,
        FString& OutError);

    /** v1-v6 saves have no authoritative MON19.2 variable snapshot. */
    GRIMROCKPROTOTYPE_API void ResetLegacyDungeonSnapshots (
