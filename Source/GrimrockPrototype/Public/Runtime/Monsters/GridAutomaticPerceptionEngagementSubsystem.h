...
namespace GridAutomaticPerceptionEngagement
{
    ...
    GRIMROCKPROTOTYPE_API void Request (
 ...
 */
UCLASS ()
class GRIMROCKPROTOTYPE_API UGridAutomaticPerceptionEngagementSubsystem
...
public:
    ...
    int32 GetQueuedRequestCount () const { return QueuedRequestCount; }
    int32 GetEffectiveEvaluationCount () const { return EffectiveEvaluationCount; }
    int32 GetSuccessfulStartCount () const { return SuccessfulStartCount; }
    bool HasPendingEvaluation () const { return bEvaluationQueued; }
