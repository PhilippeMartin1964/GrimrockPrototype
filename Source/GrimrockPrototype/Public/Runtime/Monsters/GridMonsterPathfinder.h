...
{
public:
	static bool FindPath(const FGridMonsterPathQuery& Query, const FGridMonsterPathContext& Context, FGridMonsterPathResult& OutResult);
...
public:
     ...
     */
	static bool HasStraightLineOfSight(const FIntPoint& ObserverCell, const FIntPoint& TargetCell, int32 SightRangeCells,
	...
	static bool IsTargetInFacingDirection(const FIntPoint& ObserverCell, EGridEdge Facing, const FIntPoint& TargetCell);
