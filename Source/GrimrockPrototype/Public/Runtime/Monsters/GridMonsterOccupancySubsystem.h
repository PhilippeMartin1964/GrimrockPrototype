...
public:
	...
	{
		return OccupiedCells.Num();
	}
	int32 GetReservedCellCount() const
	{
		return ReservedCells.Num();
	}
...
public:
	...
	int32 GetOccupiedCellCount() const
	{
		return Registry.GetOccupiedCellCount();
	}

	UFUNCTION(BlueprintPure, Category = "Monster|Occupancy")
	int32 GetReservedCellCount() const
	{
		return Registry.GetReservedCellCount();
	}
	...
	const FGridMonsterOccupancyRegistry& GetRegistry() const
	{
		return Registry;
	}
