...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam (
    FGridMonsterAudioPlaybackRequestedSignature,
...
public:
    ...
    int32 GetPlaybackRequestCountForEvent (
...
private:
    ...
    const FGridMonsterAudioEventDefinition* GetMonsterDefinition (
        EGridMonsterAudioEvent Event) const;
