...
class GRIMROCKPROTOTYPE_API UGridMonsterIdleVariationComponent
...
public:
    ...
    UPROPERTY (
        EditAnywhere,
        BlueprintReadOnly,
        Category = "Monster|Idle Variation")
    ...
    UPROPERTY (
        ...
        BlueprintReadOnly,
        Transient,
        Category = "Monster|Idle Variation|Debug")
    ...
    FGridMonsterIdleVariationPlaybackRequestedSignature
        OnIdleVariationPlaybackRequested;
