...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FGridPartyInventoryChangedSignature, int32, CharacterIndex);
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "RPG|Save")
	bool RestorePartyInventoryState(const FGridPartyInventoryState& SavedState, UPARAM(ref) FText& OutError);

	UFUNCTION(BlueprintCallable, Category = "RPG|Character Creation")
	bool CreateInitialCharacter(const FRPGCharacterCreationRequest& Request, UPARAM(ref) FText& OutError);

	UFUNCTION(BlueprintCallable, Category = "RPG|Character Creation")
	bool SetCharacterVisualSelection(int32 CharacterIndex, ERPGCharacterPortraitGender PortraitGender, FName PortraitVariantId,
		TSoftObjectPtr<UTexture2D> Portrait, TSoftObjectPtr<UTexture2D> ClassIcon);

	UFUNCTION(BlueprintCallable, Category = "RPG|Character Creation")
	bool GetCharacterVisualSelection(int32 CharacterIndex, FRPGCharacterVisualSelection& OutSelection) const;
	...
	UFUNCTION(BlueprintCallable, Category = "Combat|Hotbar")
	bool SetCharacterCombatHotbarBinding(int32 CharacterIndex, int32 SlotIndex, const FGridCombatHotbarBinding& Binding);
     ...
     */
	UFUNCTION(BlueprintCallable, Category = "Combat|Hotbar")
	bool ClearCharacterCombatHotbarBinding(int32 CharacterIndex, int32 SlotIndex);
	...
	UFUNCTION(BlueprintCallable, Category = "Combat|Hotbar")
	bool MoveOrSwapCharacterCombatHotbarBinding(int32 CharacterIndex, int32 SourceSlotIndex, int32 TargetSlotIndex);
	...
	bool RehydrateOwnedItemDefinitions(TFunctionRef<UGridItemDefinitionAsset*(FName)> Resolver, FName& OutMissingDefinitionId);
	...
	bool TryRestoreExtractedItemToEquipment(int32 CharacterIndex, EGridEquipmentSlot TargetSlot, const FGridItemInstance& WorldItem);
