...
struct FGridPlayerAttackPresentationProfile
{
	...
	EGridPlayerAttackMotionStyle MotionStyle = EGridPlayerAttackMotionStyle::None;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Combat|Player Attack|Feedback", meta = (ClampMin = "0.1", ClampMax = "10.0"))
...
struct FGridPlayerAttackPresentationRequest
{
	...
	UPROPERTY(BlueprintReadOnly, Transient, Category = "Combat|Player Attack|Presentation")
	EGridPlayerAttackPresentationEvent Event = EGridPlayerAttackPresentationEvent::Attack;
...
struct FGridPlayerAttackFeedbackRequest
{
	...
	UPROPERTY(BlueprintReadOnly, Transient, Category = "Combat|Player Attack|Feedback")
	EGridPlayerAttackFeedbackOutcome Outcome = EGridPlayerAttackFeedbackOutcome::Rejected;
...
{
	static FText FormatRejectReason(EGridPlayerAttackRejectReason RejectReason);
	static FGridPlayerAttackFeedbackRequest FormatResolved(const FGridPlayerAttackRequest& Request, const FGridAttackResult& Result,
