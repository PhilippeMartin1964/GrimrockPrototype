...
public:
	...
	static FGridAttackResult ResolveAttackFromRolls(const FGridAttackSourceStats& Source, const FGridAttackTargetStats& Target,
		const FGridAttackDefinition& Attack, int32 NaturalAttackRoll, int32 DamageRoll);
     ...
     */
	static FGridAttackResult ResolveDirectDamage(const FGridAttackTargetStats& Target, EGridDamageType DamageType, int32 RawDamage,
...
public:
     ...
     */
	static int32 SelectTarget(const FGridPartyInventoryState& PartyState, FRandomStream& RandomStream, int32 FrontLineSlotCount = 3);
};
