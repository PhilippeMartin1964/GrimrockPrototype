...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RPG|Recruitment", meta = (ClampMin = "0"))
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory")
	bool AddRuntimeItemToSelectedCharacterInventory(const FGuid& RuntimeObjectId, FName ItemDefinitionId, float Weight, int32 Quantity, bool bLightsEnabled);
	...
	UFUNCTION(BlueprintCallable, Category = "RPG|Recruitment")
	bool ShowStoryCompanionRecruitmentWidget(URPGStoryCompanionAsset* CompanionDefinition);
	...
	UFUNCTION(BlueprintPure, Category = "RPG|Recruitment")
	URPGStoryCompanionRecruitmentWidget* GetStoryCompanionRecruitmentWidget() const;
...
private:
	...
	void HandleCustomRecruitCommitted(URPGCharacterCreationWidget* SourceWidget, int32 CharacterIndex);
	void HandleCustomRecruitCancelled(URPGCharacterCreationWidget* SourceWidget);
	void FinishCustomRecruitCharacterCreationWidget(URPGCharacterCreationWidget* SourceWidget, bool bCommitted, int32 CharacterIndex);
