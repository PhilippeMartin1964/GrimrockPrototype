...
public:
    ...
    UPROPERTY (EditAnywhere, BlueprintReadWrite, Category = "Light", meta = (EditCondition = "bUsePointLight", ClampMin = "0.0"))
    float LightIntensity = 850.f;

    UPROPERTY (EditAnywhere, BlueprintReadWrite, Category = "Light", meta = (EditCondition = "bUsePointLight", ClampMin = "0.0"))
    float LightRadius = 325.f;

    UPROPERTY (EditAnywhere, BlueprintReadWrite, Category = "Light", meta = (EditCondition = "bUsePointLight"))
