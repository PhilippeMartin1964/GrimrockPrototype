...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FGridSpellPresentationRequestedSignature, FGridSpellPresentationRequest, Request);
...
public:
	...
	bool PresentSpell(const FGridSpellPresentationPlan& Plan, const FGridSpellPresentationProfile& Profile);
