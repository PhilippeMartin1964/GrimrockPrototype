...
{
	static FName ArcaneBoltId()
	{
		return TEXT("Spell_ArcaneBolt");
	}
	static FName LesserHealId()
	{
		return TEXT("Spell_LesserHeal");
	}
	static FName HasteId()
	{
		return TEXT("Spell_Haste");
	}
	static FName CurePoisonId()
	{
		return TEXT("Spell_CurePoison");
	}
	...
	static bool TryBuildPresentationProfile(FName SpellId, FGridSpellPresentationProfile& OutProfile);
