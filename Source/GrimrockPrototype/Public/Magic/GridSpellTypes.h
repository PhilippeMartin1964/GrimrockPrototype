...
struct GRIMROCKPROTOTYPE_API FGridSpellContract
{
    static EGridSpellValidationError ValidateDefinition (const FGridSpellDefinition& Definition)
    {
        if (Definition.SpellId.IsNone ())
        {
            return EGridSpellValidationError::MissingSpellId;
        }
        ...
        if (Definition.MinRangeCells < 0 ||
            Definition.MaxRangeCells < Definition.MinRangeCells)
        {
    ...
    static EGridSpellValidationError ValidateRequest (
        ...
        const FGridSpellCastRequest& Request)
    {
        ...
        switch (Definition.TargetingPolicy)
        {
            ...
            case EGridCombatTargetingPolicy::FirstAxialTarget:
                return Request.Target.TargetId.IsValid ()
            ...
            case EGridCombatTargetingPolicy::Area:
                return Request.Target.bHasGridCell
                    ? EGridSpellValidationError::None
                    : EGridSpellValidationError::MissingTarget;
