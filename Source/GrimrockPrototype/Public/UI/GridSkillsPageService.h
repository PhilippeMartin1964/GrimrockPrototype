...
{
	static bool TryBuildCharacterView(UGridPartyInventoryComponent* PartyInventoryComponent, int32 CharacterIndex,
	...
	static void ResolveCanonicalSkillDefinitions(TArray<const URPGSkillAsset*>& OutDefinitions);
};
