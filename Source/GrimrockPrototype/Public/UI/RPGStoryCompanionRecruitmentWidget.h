...
struct FRPGStoryCompanionRecruitmentView
{
    ...
    UPROPERTY (BlueprintReadOnly, Category = "RPG|Recruitment")
    ERPGStoryCompanionRecruitmentState State =
        ERPGStoryCompanionRecruitmentState::Uninitialized;
...
class GRIMROCKPROTOTYPE_API URPGStoryCompanionRecruitmentWidget
    : public UUserWidget
{
    GENERATED_BODY ()
...
public:
    ...
    bool InitializeRecruitmentWidget (
...
private:
    ...
    FText BuildRecruitmentFailureText (
