...
DECLARE_MULTICAST_DELEGATE_OneParam (
    FRPGLevelUpWidgetClosedNativeSignature,
...
private:
    ...
    bool BuildCombinedSelection (
        TSet<FName>& OutSelectedChoiceIds,
        TArray<FName>* OutCommittedChoiceIds = nullptr) const;
