...
struct FGridLogicNodeParams
{
    ...
    UPROPERTY (
        ...
        BlueprintReadWrite,
        Category = "Logic",
        meta = (EditCondition = "NodeType != EGridLogicNodeType::Relay", EditConditionHides))
    ...
    UPROPERTY (
        ...
        BlueprintReadWrite,
        Category = "Logic|Int",
        meta = (EditCondition = "NodeType == EGridLogicNodeType::SetInt || NodeType == EGridLogicNodeType::AddInt || NodeType == EGridLogicNodeType::SubtractInt || NodeType == EGridLogicNodeType::CompareInt", EditConditionHides))
    int32 IntValue = 0;
    ...
    UPROPERTY (
        ...
        BlueprintReadWrite,
        Category = "Logic|Int",
        meta = (EditCondition = "NodeType == EGridLogicNodeType::CompareInt", EditConditionHides))
