...
struct FGridLevelVariableDefinition
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Logic|Default", meta = (EditCondition = "Type == EGridLevelVariableType::Bool", EditConditionHides))
	bool bDefaultBoolValue = false;

	UPROPERTY(
		EditAnywhere, BlueprintReadWrite, Category = "Logic|Default", meta = (EditCondition = "Type == EGridLevelVariableType::Int32", EditConditionHides))
