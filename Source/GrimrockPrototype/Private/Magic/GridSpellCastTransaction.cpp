...
EGridSpellCastTransactionRejectReason
FGridSpellCastTransactionService::ValidateCostCommit (
    ...
    const FGridPlayerCharacterTurnState& TurnState)
{
    ...
    if (Spellbook.CharacterId != Request.CasterCharacterId ||
        TurnState.CharacterId != Request.CasterCharacterId)
    {
    ...
    if (CharacterStats.CurrentMana < 0 ||
        Definition.ManaCost > CharacterStats.CurrentMana)
    {
...
bool FGridSpellCastTransactionService::TryCommitCosts (
    const FGridSpellDefinition& Definition,
    const FGridSpellCastRequest& Request,
    const FGridCharacterSpellbookState& Spellbook,
    ...
    EGridSpellCastTransactionRejectReason& OutRejectReason)
{
    ...
    OutRejectReason = ValidateCostCommit (
        Definition,
        Request,
        Spellbook,
        InOutCharacterStats,
    ...
    InOutTurnState.RemainingActionPoints =
        PreviousActionPoints - Definition.ActionPointCost;
    InOutCharacterStats.CurrentMana =
        PreviousMana - Definition.ManaCost;
