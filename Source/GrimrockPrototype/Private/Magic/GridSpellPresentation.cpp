...
bool FGridSpellPresentationService::BuildPlan (
    ...
    FGridSpellPresentationPlan& OutPlan)
{
    ...
    OutPlan.ProjectileTravelDurationSeconds =
        Profile.Projectile.bEnabled
...
float FGridSpellPresentationService::CalculateProjectileLaunchDelay (
    float ImpactTimeSeconds,
    const FGridSpellPresentationProfile& Profile)
{
    return Profile.Projectile.bEnabled
...
FVector FGridSpellPresentationService::EvaluateProjectileTrajectory (
    const FVector& Source,
    const FVector& Target,
    float Alpha)
{
    return AGridCombatProjectileActor::EvaluateTrajectoryLocation (
        Source,
        Target,
        Alpha);
}
