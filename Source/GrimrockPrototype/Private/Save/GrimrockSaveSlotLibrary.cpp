...
bool UGrimrockSaveSlotLibrary::SavePartyGameToSlot(AGrimrockPartyPawn* PartyPawn, const FString& SlotName, int32 UserIndex, FText& OutError)
{
...
bool UGrimrockSaveSlotLibrary::SavePartyGameCopyToSlot(AGrimrockPartyPawn* PartyPawn, const FString& SlotName, int32 UserIndex, FText& OutError)
{
	OutError = FText::GetEmpty();
