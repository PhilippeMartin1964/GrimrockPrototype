...
bool FGridMonsterOccupancyRegistry::CommitReservation (
...
bool FGridMonsterOccupancyRegistry::IsCellOccupied (
    const FIntPoint& Cell,
    const FGuid& IgnoredMonsterId) const
{
    const FGuid* Occupant = OccupiedCells.Find (Cell);
    return Occupant && (!IgnoredMonsterId.IsValid () || *Occupant != IgnoredMonsterId);
}

bool FGridMonsterOccupancyRegistry::IsCellReserved (
    const FIntPoint& Cell,
    const FGuid& IgnoredMonsterId) const
{
...
bool FGridMonsterOccupancyRegistry::IsCellBlocked (
    const FIntPoint& Cell,
    const FGuid& IgnoredMonsterId) const
{
...
bool UGridMonsterOccupancySubsystem::CommitMove (
...
bool UGridMonsterOccupancySubsystem::IsCellOccupied (
    FIntPoint Cell,
...
bool UGridMonsterOccupancySubsystem::IsCellReserved (
    FIntPoint Cell,
    const AGridMonsterActor* IgnoredMonster) const
{
...
bool UGridMonsterOccupancySubsystem::IsCellBlocked (
    FIntPoint Cell,
    const AGridMonsterActor* IgnoredMonster) const
{
