...
namespace
{
    ...
    FGridCombatAction MakeRangedAttackAction (
        const FGuid& SourceActorId,
...
EGridEdge FGridMonsterRangedAttackPlanner::GetAxialDirection (
    ...
    const FIntPoint& TargetCell)
{
    ...
    {
        return TargetCell.Y > SourceCell.Y
            ? EGridEdge::North
            : EGridEdge::South;
    }
    ...
    {
        return TargetCell.X > SourceCell.X
            ? EGridEdge::East
            : EGridEdge::West;
    }
...
bool FGridMonsterRangedAttackPlanner::BuildStationaryRangedTurn (
    const FGuid& SourceActorId,
    ...
    TArray<FGridCombatAction>& OutActions)
{
    ...
    if (!Attack.IsValidDefinition () ||
        ...
        Attack.AttackId.IsNone () ||
        AvailableActionPoints < Attack.ActionPointCost ||
    ...
    const int32 Distance =
        FGridMonsterPathfinder::ManhattanDistance (
            StartCell,
            PartyCell);
    const EGridEdge AttackFacing = GetAxialDirection (
        StartCell,
        PartyCell);
    if (AttackFacing == EGridEdge::None ||
        !Attack.SupportsDistance (Distance))
    {
        return false;
    }
    ...
    OutActions.Add (MakeRangedAttackAction (
        SourceActorId,
        PartyCell,
        Attack.AttackId,
