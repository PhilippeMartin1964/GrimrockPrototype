...
bool AGrimrockPartyPawn::SaveCurrentGame(FText& OutError)
{
	...
	UGridPartySpellbookComponent* SpellbookComponent = GetPawnSpellbookComponent(this);
...
void AGrimrockPartyPawn::SyncHeldVisualFromSelectedCharacterEquipment()
{
	...
	UE_LOG(LogTemp, Log, TEXT("GridInventory HeldVisual Sync Equipped Character=%d Slot=%s Item=%s"), CharacterIndex, GetPawnEquipmentSlotName(VisualSlot),
