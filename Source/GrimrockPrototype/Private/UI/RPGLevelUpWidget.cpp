...
"Ce choix est requis par une autre sélection en attente.");
RefreshNativeSlate ();
BP_OnLevelUpViewRefreshed ();
return false;
}
...
"La sélection de progression est incohérente.");
View = MoveTemp (NewView);
RefreshNativeSlate ();
BP_OnLevelUpViewRefreshed ();
return;
...
NewView.ValidationMessage = LOCTEXT (
"InvalidPointBalance",
"Le budget de progression est invalide.");
View = MoveTemp (NewView);
RefreshNativeSlate ();
BP_OnLevelUpViewRefreshed ();
return;
...
NewView.ValidationMessage = LOCTEXT (
"ChooseOrCancel",
"Sélectionnez un choix de progression, ou annulez pour le reporter.");
}
View = MoveTemp (NewView);
RefreshNativeSlate ();
BP_OnLevelUpViewRefreshed ();
...
return LOCTEXT ("ChoiceUnknown", "Choix inconnu");
...
return LOCTEXT ("ChoiceInsufficientPoints", "Points insuffisants");
