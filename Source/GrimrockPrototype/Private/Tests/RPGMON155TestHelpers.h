...
namespace
{
    ...
    URPGClassAsset* MakeMON155Class (UObject* Outer)
    {
        ...
        ClassDefinition->DisplayName =
            FText::FromString (TEXT ("MON15.5 Fighter"));
    ...
    FGridCharacterInventoryState MakeMON155Character (
        URPGClassAsset* ClassDefinition,
        int32 Level,
        int32 Experience,
        const TCHAR* DisplayName = TEXT ("Elias"))
    {
    ...
    UGridPartyInventoryComponent* MakeMON155Inventory (
    ...
    TSet<FName> GetMON155RuntimeRequirements (
        UGridPartyInventoryComponent* Component,
        int32 CharacterIndex)
    {
        TSet<FName> Requirements;
        if (!Component ||
            !Component->PartyInventoryState.ActiveCharacters.IsValidIndex (
                CharacterIndex))
        {
            return Requirements;
        }
        ...
        const FGridCharacterInventoryState& Character =
            Component->PartyInventoryState.ActiveCharacters[CharacterIndex];
    ...
    FGridAvailableCombatAction BuildMON155ChoiceActionAvailability (
        UGridPartyInventoryComponent* Component,
        URPGClassAsset* ClassDefinition)
    {
        const FGridCharacterInventoryState& Character =
