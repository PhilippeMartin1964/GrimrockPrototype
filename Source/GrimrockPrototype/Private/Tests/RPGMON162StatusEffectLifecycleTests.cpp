...
namespace
{
    UGridStatusEffectDefinitionAsset* MON162MakeDefinition (
        UObject* Outer,
        FName EffectId,
    ...
    struct FGridMON162TestWorld
    {
        ...
        FGridMON162TestWorld ()
        {
            ...
            World = UWorld::CreateWorld (
                EWorldType::Game,
                false,
                FName (*FString::Printf (TEXT ("MON162TestWorld_%s"), *FGuid::NewGuid ().ToString (EGuidFormats::Digits))),
                nullptr,
                true,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162TurnDurationLifecycleTest, "Grimrock.RPG.MON16.2.TurnDurationLifecycle", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162RoundDurationLifecycleTest, "Grimrock.RPG.MON16.2.RoundDurationLifecycle", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162PermanentDurationLifecycleTest, "Grimrock.RPG.MON16.2.PermanentDurationLifecycle", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FRPGMON162PermanentDurationLifecycleTest::RunTest (const FString& Parameters)
{
    UGridStatusEffectDefinitionAsset* Permanent = MON162MakeDefinition (GetTransientPackage (), TEXT ("PermanentBlessing"), EGridStatusEffectDurationUnit::Permanent, 0);
    FGridStatusEffectCollection Collection;
    FString Error;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162NoStackAndRefreshTest, "Grimrock.RPG.MON16.2.NoStackAndRefresh", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FRPGMON162NoStackAndRefreshTest::RunTest (const FString& Parameters)
{
    UGridStatusEffectDefinitionAsset* NoStack = MON162MakeDefinition (GetTransientPackage (), TEXT ("Stunned"), EGridStatusEffectDurationUnit::Turns, 1, EGridStatusEffectStackPolicy::NoStack);
    UGridStatusEffectDefinitionAsset* Refresh = MON162MakeDefinition (GetTransientPackage (), TEXT ("Haste"), EGridStatusEffectDurationUnit::Rounds, 3, EGridStatusEffectStackPolicy::RefreshDuration, 1, 2);
    FString Error;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162AddStacksTest, "Grimrock.RPG.MON16.2.AddStacks", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FRPGMON162AddStacksTest::RunTest (const FString& Parameters)
{
    UGridStatusEffectDefinitionAsset* Poison = MON162MakeDefinition (GetTransientPackage (), TEXT ("Poison"), EGridStatusEffectDurationUnit::Rounds, 3, EGridStatusEffectStackPolicy::AddStacks, 3, 1);
    FGridStatusEffectCollection Collection;
    FGridStatusEffectApplyResult Result;
    FString Error;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162ReplaceIfStrongerTest, "Grimrock.RPG.MON16.2.ReplaceIfStronger", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FRPGMON162ReplaceIfStrongerTest::RunTest (const FString& Parameters)
{
    UGridStatusEffectDefinitionAsset* Slow = MON162MakeDefinition (GetTransientPackage (), TEXT ("Slow"), EGridStatusEffectDurationUnit::Rounds, 3, EGridStatusEffectStackPolicy::ReplaceIfStronger, 1, 5);
    FGridStatusEffectCollection Collection;
    FGridStatusEffectApplyResult Result;
    FString Error;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162AtomicFailureTest, "Grimrock.RPG.MON16.2.AtomicFailure", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FRPGMON162AtomicFailureTest::RunTest (const FString& Parameters)
{
    UGridStatusEffectDefinitionAsset* Rounds = MON162MakeDefinition (GetTransientPackage (), TEXT ("ArmorBuff"), EGridStatusEffectDurationUnit::Rounds, 3, EGridStatusEffectStackPolicy::RefreshDuration, 1, 2);
    UGridStatusEffectDefinitionAsset* Turns = MON162MakeDefinition (GetTransientPackage (), TEXT ("ArmorBuff"), EGridStatusEffectDurationUnit::Turns, 3, EGridStatusEffectStackPolicy::RefreshDuration, 1, 2);
    FGridStatusEffectCollection Collection;
    FGridStatusEffectApplyResult Result;
    FString Error;
    const FGuid Original = FGuid::NewGuid ();
    ...
    TestTrue (TEXT ("Failures preserve state"), State && State->SourceId == Original && State->RemainingDuration == 3 && State->Potency == 2 && Collection.Num () == 1);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162DeterministicExpirationTest, "Grimrock.RPG.MON16.2.DeterministicExpiration", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162TurnManagerEventIntegrationTest, "Grimrock.RPG.MON16.2.TurnManagerEventIntegration", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FRPGMON162TurnManagerEventIntegrationTest::RunTest (const FString& Parameters)
{
    ...
    if (!Party || !Party->PartyInventoryComponent || !Owner || !Monster) return false;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (FRPGMON162NoUIDependencyTest, "Grimrock.RPG.MON16.2.NoUIDependency", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
