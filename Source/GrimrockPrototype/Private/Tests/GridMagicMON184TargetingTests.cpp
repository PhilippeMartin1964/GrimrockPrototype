...
namespace
{
    ...
    FGridSpellCastRequest MakeTargetingRequest (
    ...
    FGridCharacterSpellbookState MakeTargetingSpellbook (
        const FGuid& CharacterId)
    {
    ...
    FGridPlayerCharacterTurnState MakeTargetingTurn (
        const FGuid& CharacterId,
    ...
    FGridSpellTargetingContext MakeHostileContext (
        const FGuid& TargetId,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON184AxialTargetSuccessTest,
...
bool FGridMON184AxialTargetSuccessTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (TEXT ("Valid axial target commits"), TryPipeline (
        Definition, Request, Context, Spellbook, Stats, Turn,
        ResolvedTarget, Receipt, RejectStage, TargetReject, TransactionReject));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON184OutOfRangeNoMutationTest,
...
bool FGridMON184OutOfRangeNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (TEXT ("Out of range rejected"), TryPipeline (
        Definition, Request, Context, Spellbook, Stats, Turn,
        ResolvedTarget, Receipt, RejectStage, TargetReject, TransactionReject));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON184NonAxialNoMutationTest,
...
bool FGridMON184NonAxialNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (TEXT ("Non axial target rejected"), TryPipeline (
        Definition, Request, Context, Spellbook, Stats, Turn,
        ResolvedTarget, Receipt, RejectStage, TargetReject, TransactionReject));
    TestEqual (TEXT ("Mana unchanged"), Stats.CurrentMana, 8);
    TestEqual (TEXT ("PA unchanged"), Turn.RemainingActionPoints, 3);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON184LineOfSightNoMutationTest,
...
bool FGridMON184LineOfSightNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (TEXT ("Blocked LOS rejected"), TryPipeline (
        Definition, Request, Context, Spellbook, Stats, Turn,
        ResolvedTarget, Receipt, RejectStage, TargetReject, TransactionReject));
    TestEqual (TEXT ("Mana unchanged"), Stats.CurrentMana, 8);
    TestEqual (TEXT ("PA unchanged"), Turn.RemainingActionPoints, 3);
...
bool FGridMON184AllyRelationTest::RunTest (const FString& Parameters)
{
    ...
    TestEqual (
        TEXT ("Ally accepted"),
        FGridSpellTargetingService::ValidateAndResolveTarget (
            Definition, Request, Context, ResolvedTarget),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON184CellAreaResolutionTest,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON184TransactionFailureAfterTargetTest,
...
bool FGridMON184TransactionFailureAfterTargetTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (TEXT ("Transaction rejection returned"), TryPipeline (
        Definition, Request, Context, Spellbook, Stats, Turn,
        ResolvedTarget, Receipt, RejectStage, TargetReject, TransactionReject));
