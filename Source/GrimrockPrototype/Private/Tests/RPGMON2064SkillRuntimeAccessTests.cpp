...
namespace RPGMON2064SkillRuntimeAccessTests
{
    ...
    UGridPartyInventoryComponent* MakeParty ()
    {
        ...
        Party->PartyInventoryState.ActiveCharacters.Add (
            MakeCharacter (TEXT ("A"), 10, 1));
        Party->PartyInventoryState.ActiveCharacters.Add (
            MakeCharacter (TEXT ("B"), 16, 4));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeExplicitRankTest,
    "Grimrock.MON20.6.Skills.RuntimeExplicitRank",
...
bool FRPGMON2064RuntimeExplicitRankTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (
        TEXT ("Explicit character rank query succeeds"),
        FRPGSkillRuntimeService::TryGetCharacterSkillRank (
            Party, 1, LockpickingId, Rank));
    TestEqual (TEXT ("Character 1 rank is returned"), Rank, 4);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeSelectedRankTest,
    "Grimrock.MON20.6.Skills.RuntimeSelectedRank",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRPGMON2064RuntimeSelectedRankTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (
        TEXT ("Selected rank query succeeds for character 1"),
        FRPGSkillRuntimeService::TryGetSelectedCharacterSkillRank (
            Party, LockpickingId, Rank));
    TestEqual (TEXT ("Selected character 1 rank"), Rank, 4);

    TestTrue (TEXT ("Select character 0"), Party->SetSelectedCharacterIndex (0));
    TestTrue (
        TEXT ("Selected rank query follows selection"),
        FRPGSkillRuntimeService::TryGetSelectedCharacterSkillRank (
            Party, LockpickingId, Rank));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeSelectedMutationTest,
    "Grimrock.MON20.6.Skills.RuntimeSelectedMutation",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRPGMON2064RuntimeSelectedMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (
        TEXT ("Selected mutation succeeds"),
        FRPGSkillRuntimeService::TrySetSelectedCharacterSkillRank (
            Party, Skill, 2, Result));
    ...
    TestEqual (
        TEXT ("Selected character changed"),
        Party->PartyInventoryState.ActiveCharacters[1].SkillRanks[0].Rank,
        2);
    TestEqual (
        TEXT ("Unselected character unchanged"),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeIncreaseMutationTest,
    "Grimrock.MON20.6.Skills.RuntimeIncreaseMutation",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRPGMON2064RuntimeIncreaseMutationTest::RunTest (const FString& Parameters)
{
    ...
    FRPGSkillMutationResult Result;
    TestTrue (
        TEXT ("Explicit increase succeeds"),
        FRPGSkillRuntimeService::TryIncreaseCharacterSkillRank (
            Party, 0, Skill, 2, Result));
    TestEqual (TEXT ("Previous rank"), Result.PreviousRank, 1);
    TestEqual (TEXT ("Increased rank"), Result.NewRank, 3);

    int32 Rank = 0;
    TestTrue (
        TEXT ("Updated rank remains queryable"),
        FRPGSkillRuntimeService::TryGetCharacterSkillRank (
            Party, 0, LockpickingId, Rank));
    TestEqual (TEXT ("Runtime rank is three"), Rank, 3);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeInvalidMutationAtomicTest,
    "Grimrock.MON20.6.Skills.RuntimeInvalidMutationAtomic",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FRPGMON2064RuntimeInvalidMutationAtomicTest::RunTest (
    const FString& Parameters)
{
    ...
    UGridPartyInventoryComponent* Party = MakeParty ();
    URPGSkillAsset* Skill = MakeSkill ();
    const int32 RankBefore =
        Party->PartyInventoryState.ActiveCharacters[0].SkillRanks[0].Rank;

    FRPGSkillMutationResult Result;
    TestFalse (
        TEXT ("Invalid character mutation is rejected"),
        FRPGSkillRuntimeService::TrySetCharacterSkillRank (
            Party, 99, Skill, 5, Result));
    TestTrue (
        TEXT ("Reject reason uses invalid current state"),
        Result.RejectReason == ERPGSkillMutationRejectReason::InvalidCurrentState);
    TestEqual (
        TEXT ("Existing character rank is unchanged"),
        Party->PartyInventoryState.ActiveCharacters[0].SkillRanks[0].Rank,
        RankBefore);
    return true;
}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeExplicitCheckTest,
    "Grimrock.MON20.6.Skills.RuntimeExplicitCheck",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRPGMON2064RuntimeExplicitCheckTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (
        ...
        FRPGSkillCheckService::TryResolveSkillCheck (
            ...
            DirectResult));
    TestTrue (
        TEXT ("Runtime explicit service resolves"),
        FRPGSkillRuntimeService::TryResolveCharacterSkillCheck (
            Party,
            0,
            Skill,
            12,
    ...
    TestTrue (
        TEXT ("Runtime success matches direct success"),
        RuntimeResult.bSuccess == DirectResult.bSuccess);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeSelectedCheckTest,
    "Grimrock.MON20.6.Skills.RuntimeSelectedCheck",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRPGMON2064RuntimeSelectedCheckTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (
        TEXT ("Direct selected character check resolves"),
        FRPGSkillCheckService::TryResolveSkillCheck (
            Party->PartyInventoryState.ActiveCharacters[1],
            Skill,
            18,
            DirectStream,
            DirectResult));
    TestTrue (
        TEXT ("Selected runtime check resolves"),
        FRPGSkillRuntimeService::TryResolveSelectedCharacterSkillCheck (
            Party,
            Skill,
            18,
            SelectedStream,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FRPGMON2064RuntimeInvalidCharacterCheckNoRandomTest,
    "Grimrock.MON20.6.Skills.RuntimeInvalidCharacterCheckNoRandom",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FRPGMON2064RuntimeInvalidCharacterCheckNoRandomTest::RunTest (
    const FString& Parameters)
{
    (void)Parameters;
    using namespace RPGMON2064SkillRuntimeAccessTests;
    ...
    TestFalse (
        TEXT ("Invalid character check is rejected"),
        FRPGSkillRuntimeService::TryResolveCharacterSkillCheck (
            Party,
            99,
            Skill,
            ...
            Result));
    TestTrue (
        TEXT ("Invalid character reject reason"),
        Result.RejectReason == ERPGSkillCheckRejectReason::InvalidCharacterState);
    TestEqual (
        TEXT ("Invalid character does not consume RNG"),
        RuntimeStream.RandRange (1, 20),
        ExpectedNextRoll);
    return true;
}
