...
namespace
{
    FGridCharacterSpellbookState MakeMON1892Spellbook (
    ...
    FGridPlayerCharacterTurnState MakeMON1892TurnState (
        const FGuid& CharacterId)
    {
    ...
    FGridSpellCastRequest MakeMON1892AllyRequest (
        const FGuid& CharacterId,
        FName SpellId)
    {
    ...
    FGridSpellTargetingContext MakeMON1892AllyContext (
        const FGuid& CharacterId)
    {
    ...
    UGridStatusEffectDefinitionAsset* MakeMON1892StatusDefinition (
        FName EffectId)
    {
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON1892BalanceContractTest,
    "Grimrock.Magic.MON18.9.2.BalanceContract",
...
bool FGridMON1892BalanceContractTest::RunTest (const FString& Parameters)
{
    ...
    const FGridSpellDefinition ArcaneBolt =
        FGridProductionSpellLibrary::MakeArcaneBolt ();
    const FGridSpellDefinition LesserHeal =
        FGridProductionSpellLibrary::MakeLesserHeal ();
    const FGridSpellDefinition Haste =
        FGridProductionSpellLibrary::MakeHaste ();
    const FGridSpellDefinition CurePoison =
        FGridProductionSpellLibrary::MakeCurePoison ();
    ...
    const FGridCombatActionDefinition Action =
        UGridSpellbookUILibrary::MakeSpellCombatActionDefinition (ArcaneBolt);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON1892FullHealthHealNoCostTest,
    "Grimrock.Magic.MON18.9.2.FullHealthHealNoCost",
    EAutomationTestFlags::EditorContext |
        EAutomationTestFlags::EngineFilter)
...
bool FGridMON1892FullHealthHealNoCostTest::RunTest (const FString& Parameters)
{
    ...
    const FGridPlayerCharacterTurnState TurnState =
        MakeMON1892TurnState (CharacterId);
    FGridSpellHotbarExecutionResult Result;

    TestFalse (
        TEXT ("Lesser Heal rejects a full-health target"),
        FGridSpellHotbarExecutionService::TryExecute (
            Definition,
            MakeMON1892AllyRequest (CharacterId, Definition.SpellId),
            MakeMON1892AllyContext (CharacterId),
            MakeMON1892Spellbook (CharacterId, Definition.SpellId),
            CasterStats,
            TurnState,
            20,
            20,
            FGridStatusEffectCollection (),
            [] (FName) -> const UGridStatusEffectDefinitionAsset* { return nullptr; },
            Result));
    TestEqual (TEXT ("No-effect rejection"),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON1892CleanCureNoCostTest,
    "Grimrock.Magic.MON18.9.2.CurePoisonCleanTargetNoCost",
    EAutomationTestFlags::EditorContext |
        EAutomationTestFlags::EngineFilter)
...
bool FGridMON1892CleanCureNoCostTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (
        TEXT ("Cure Poison rejects a clean target"),
        FGridSpellHotbarExecutionService::TryExecute (
            Definition,
            MakeMON1892AllyRequest (CharacterId, Definition.SpellId),
            MakeMON1892AllyContext (CharacterId),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON1892CurePoisonCommitTest,
    "Grimrock.Magic.MON18.9.2.CurePoisonCommit",
    EAutomationTestFlags::EditorContext |
        EAutomationTestFlags::EngineFilter)
...
bool FGridMON1892CurePoisonCommitTest::RunTest (const FString& Parameters)
{
    ...
    UGridStatusEffectDefinitionAsset* Poison =
        MakeMON1892StatusDefinition (TEXT ("Status_Poison"));
    FGridStatusEffectCollection Statuses;
    FString AddError;
    TestTrue (TEXT ("Poison fixture added"),
    ...
    FGridSpellHotbarExecutionResult Result;
    TestTrue (
        TEXT ("Cure Poison executes when poison is present"),
        FGridSpellHotbarExecutionService::TryExecute (
            Definition,
            MakeMON1892AllyRequest (CharacterId, Definition.SpellId),
            MakeMON1892AllyContext (CharacterId),
            MakeMON1892Spellbook (CharacterId, Definition.SpellId),
            MakeMON1892CasterStats (),
            MakeMON1892TurnState (CharacterId),
            20,
            20,
            Statuses,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON1892HasteCommitTest,
    "Grimrock.Magic.MON18.9.2.HasteCommit",
    EAutomationTestFlags::EditorContext |
        EAutomationTestFlags::EngineFilter)
...
bool FGridMON1892HasteCommitTest::RunTest (const FString& Parameters)
{
    ...
    UGridStatusEffectDefinitionAsset* Haste =
        MakeMON1892StatusDefinition (TEXT ("Status_Haste"));
    const FGridSpellDefinition Definition =
        FGridProductionSpellLibrary::MakeHaste ();
    FGridSpellHotbarExecutionResult Result;

    TestTrue (
        TEXT ("Haste executes through the MON16 bridge"),
        FGridSpellHotbarExecutionService::TryExecute (
            Definition,
            MakeMON1892AllyRequest (CharacterId, Definition.SpellId),
            MakeMON1892AllyContext (CharacterId),
