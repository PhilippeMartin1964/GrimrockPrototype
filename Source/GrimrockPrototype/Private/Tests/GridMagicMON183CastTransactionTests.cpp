...
namespace
{
    ...
    FGridCharacterSpellbookState MakeSpellbook (
        const FGuid& CharacterId,
        bool bKnowsSpell = true)
    {
    ...
    FGridPlayerCharacterTurnState MakeTurn (
        const FGuid& CharacterId,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON183SuccessfulCommitTest,
...
bool FGridMON183SuccessfulCommitTest::RunTest (const FString& Parameters)
{
    ...
    EGridSpellCastTransactionRejectReason RejectReason =
        EGridSpellCastTransactionRejectReason::InvalidRequest;

    TestTrue (
        TEXT ("Valid cast costs commit"),
        FGridSpellCastTransactionService::TryCommitCosts (
            Definition,
            Request,
            Spellbook,
            Stats,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON183UnknownSpellNoMutationTest,
...
bool FGridMON183UnknownSpellNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (
        TEXT ("Unknown spell rejected"),
        FGridSpellCastTransactionService::TryCommitCosts (
            Definition, Request, Spellbook, Stats, Turn, Receipt, RejectReason));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON183InsufficientManaNoMutationTest,
...
bool FGridMON183InsufficientManaNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (
        TEXT ("Insufficient mana rejected"),
        FGridSpellCastTransactionService::TryCommitCosts (
            Definition, Request, Spellbook, Stats, Turn, Receipt, RejectReason));
    ...
    TestEqual (
        TEXT ("Reject reason"),
        RejectReason,
        EGridSpellCastTransactionRejectReason::InsufficientMana);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON183InsufficientActionPointsNoMutationTest,
...
bool FGridMON183InsufficientActionPointsNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestEqual (
        TEXT ("Reject reason"),
        RejectReason,
        EGridSpellCastTransactionRejectReason::InsufficientActionPoints);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON183IdentityMismatchNoMutationTest,
...
bool FGridMON183IdentityMismatchNoMutationTest::RunTest (const FString& Parameters)
{
    ...
    TestFalse (
        TEXT ("Character mismatch rejected"),
        FGridSpellCastTransactionService::TryCommitCosts (
            Definition, Request, Spellbook, Stats, Turn, Receipt, RejectReason));
    TestEqual (TEXT ("Mana unchanged"), Stats.CurrentMana, 10);
    TestEqual (TEXT ("PA unchanged"), Turn.RemainingActionPoints, 3);
    TestEqual (
        TEXT ("Reject reason"),
        RejectReason,
        EGridSpellCastTransactionRejectReason::CharacterMismatch);
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON183TargetingDeferredTest,
...
bool FGridMON183TargetingDeferredTest::RunTest (const FString& Parameters)
{
    ...
    TestTrue (
        TEXT ("Cost transaction deliberately ignores target payload until MON18.4"),
        FGridSpellCastTransactionService::TryCommitCosts (
            Definition, Request, Spellbook, Stats, Turn, Receipt, RejectReason));
    TestEqual (TEXT ("Mana paid"), Stats.CurrentMana, 6);
    TestEqual (TEXT ("PA paid"), Turn.RemainingActionPoints, 1);
