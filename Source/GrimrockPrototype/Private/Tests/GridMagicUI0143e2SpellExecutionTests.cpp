...
namespace
{
	FGridCharacterSpellbookState MakeUI0143e2Spellbook(const FGuid& CharacterId, FName SpellId)
	{
	...
	FGridSpellCastRequest MakeUI0143e2Request(const FGuid& CharacterId, FName SpellId, const FGuid& TargetId, FIntPoint TargetCell)
	{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FGridUI0143e2ArcaneBoltExecutionTest, "Grimrock.UI.UI01.4.3e.2.ArcaneBoltExecution",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGridUI0143e2ArcaneBoltExecutionTest::RunTest(const FString& Parameters)
{
	(void)Parameters;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FGridUI0143e2LesserHealExecutionTest, "Grimrock.UI.UI01.4.3e.2.LesserHealExecution",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGridUI0143e2LesserHealExecutionTest::RunTest(const FString& Parameters)
{
	(void)Parameters;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FGridUI0143e2MissingStatusNoCostCommitTest, "Grimrock.UI.UI01.4.3e.2.MissingStatusNoCostCommit",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGridUI0143e2MissingStatusNoCostCommitTest::RunTest(const FString& Parameters)
{
	(void)Parameters;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FGridUI0143e2UnknownSpellNoCostCommitTest, "Grimrock.UI.UI01.4.3e.2.UnknownSpellNoCostCommit",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGridUI0143e2UnknownSpellNoCostCommitTest::RunTest(const FString& Parameters)
{
	(void)Parameters;
