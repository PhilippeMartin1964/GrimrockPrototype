...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FGridMonsterMON3OccupancyRegistryTest, "Grimrock.Monsters.MON3.OccupancyRegistry", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FGridMonsterMON3InvalidTransitionsTest, "Grimrock.Monsters.MON3.InvalidTransitions",
...
bool FGridMonsterMON3InvalidTransitionsTest::RunTest(const FString& Parameters)
{
	...
	TestFalse(TEXT("A reservation cannot be committed from the wrong source"), Registry.CommitReservation(Rat, FIntPoint(1, 2), Target));
