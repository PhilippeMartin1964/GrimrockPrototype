...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FGridEditorMON2055CustomRecruitLinkPolicyTest, "Grimrock.MON20.5.CustomRecruit.EditorLinkPolicy",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGridEditorMON2055CustomRecruitLinkPolicyTest::RunTest(const FString& Parameters)
{
	(void)Parameters;
