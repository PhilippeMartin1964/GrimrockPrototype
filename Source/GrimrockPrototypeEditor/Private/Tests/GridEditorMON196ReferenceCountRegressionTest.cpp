...
IMPLEMENT_SIMPLE_AUTOMATION_TEST (
    FGridMON196LuaReferenceCountRegressionTest,
    "Grimrock.MON19.6.Editor.LuaReferenceCountRegression",
    EAutomationTestFlags::EditorContext |
        EAutomationTestFlags::EngineFilter)

bool FGridMON196LuaReferenceCountRegressionTest::RunTest (
    const FString& Parameters)
{
    ...
    TestEqual (
        TEXT ("Two bindings referencing Puzzle are counted"),
        GridEditorLuaService::CountScriptReferences (*Level, TEXT ("Puzzle")),
        2);
    TestEqual (
        TEXT ("One binding referencing OtherPuzzle is counted"),
        GridEditorLuaService::CountScriptReferences (*Level, TEXT ("OtherPuzzle")),
        1);
    TestEqual (
        TEXT ("Missing script has zero references"),
        GridEditorLuaService::CountScriptReferences (*Level, TEXT ("Missing")),
        0);
    return true;
}
