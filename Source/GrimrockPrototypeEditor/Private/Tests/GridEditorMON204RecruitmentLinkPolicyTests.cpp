...
bool FGridEditorMON2044RecruitmentLinkPolicyTest::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("OfferRecruitment has Gameplay runtime support"),
		GridEditorLinkPolicy::GetCommandRuntimeSupport(Companion, EGridObjectCommand::OfferRecruitment) == EGridEditorCommandRuntimeSupport::Gameplay);
	TestTrue(TEXT("Story companion rejects generic Toggle"),
		GridEditorLinkPolicy::GetCommandRuntimeSupport(Companion, EGridObjectCommand::Toggle) == EGridEditorCommandRuntimeSupport::Unsupported);
