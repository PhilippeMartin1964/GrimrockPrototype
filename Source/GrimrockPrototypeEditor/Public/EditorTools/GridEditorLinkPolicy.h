...
namespace GridEditorLinkPolicy
{
     ...
     */
    GRIMROCKPROTOTYPEEDITOR_API TArray<EGridObjectCondition>
        GetSupportedConditionsForTarget (
            const FGridLevelObjectData& ObjectData);
     ...
     */
    GRIMROCKPROTOTYPEEDITOR_API EGridEditorCommandRuntimeSupport
        GetCommandRuntimeSupport (
            const FGridLevelObjectData& ObjectData,
     ...
     */
    GRIMROCKPROTOTYPEEDITOR_API bool AreLinksExactlyEquivalent (
